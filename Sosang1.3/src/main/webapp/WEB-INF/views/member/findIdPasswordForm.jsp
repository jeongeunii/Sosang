...
<body>
	<div class="findIdPasswordForm" name="findIdPasswordForm" style="margin: 0 auto; width: 450px;">
		<div class="wrapper">
			...
			<form class="searchID" method="POST" name="searchID">
			...
			<br>	
			<form class="searchPassword" method="POST" name="searchPassword">
	...
	$(document).ready(function() {
		...
		$("#findPasswordBtn").click(function(){
			if(${sessionScope.id == null}){
				...
				document.searchPassword.method = "POST";
