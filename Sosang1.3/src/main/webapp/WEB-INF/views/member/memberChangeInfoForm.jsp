...
<head>
<meta charset="UTF-8">
<title>Member Change Info Form</title>
...
<body>
    ...
    padding: 0%;"></div>
			...
			<h3 style="text-align:center;">${message }</h3>
				...
				<div class="input_field">
					<input type="text" placeholder="Name" class="name" name="name" id="name" value="${name}" >
				...
				<div class="input_field">
					<input type="password" placeholder="Password" class="password" name="password" id="password" value="${password}">
					<i class="fas fa-key"></i>
				</div>
				<div class="input_field">
					<input type="password" placeholder="Confirm Password" class="confirmPassword" id="confirmPassword" name="confirmPassword" value="${password}">
